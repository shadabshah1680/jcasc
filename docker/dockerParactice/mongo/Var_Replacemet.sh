...
sed -i "s|ROOT_USER_NAME|${ROOT_USER_NAME}|g" Dockerfile
sed -i "s|ROOT_PASS_WORD|${ROOT_PASS_WORD}|g" Dockerfile
sed -i "s|APPLICATION_DATA_BASE|${APPLICATION_DATA_BASE}|g" Dockerfile