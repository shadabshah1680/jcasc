...
sed -i "s|ROOT_USER_NAME|${ROOT_USER_NAME}|g" /home/ec2-user/Eurus_Docker/docker-compose.yml
sed -i "s|ROOT_PASS_WORD|${ROOT_PASS_WORD}|g" /home/ec2-user/Eurus_Docker/docker-compose.yml
...
sed -i "s|APPLICATION_DATA_BASE|${APPLICATION_DATA_BASE}|g" /home/ec2-user/Eurus_Docker/mongo_user.sh
sed -i "s|APPLICATION_USER_NAME|${APPLICATION_USER_NAME}|g" /home/ec2-user/Eurus_Docker/mongo_user.sh
sed -i "s|APPLICATION_PASS_WORD|${APPLICATION_PASS_WORD}|g" /home/ec2-user/Eurus_Docker/mongo_user.sh